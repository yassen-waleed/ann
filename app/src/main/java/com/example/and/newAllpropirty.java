...
public class newAllpropirty extends AppCompatActivity {
...
SessionManager sessionManager ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_allpropirty);
      ...
      Cursor cursor  = databaseHelper.getData("SELECT * FROM property where agency_id = '"+email+"'") ;
      while(cursor.moveToNext()){
         ...
         String agency  = cursor.getString( 1)  ;
          ...
          String rented  = cursor.getString( 13)  ;
          propirties.add(new Propirty(id,agency,city,postal,surface,year,bed,price,status,date,discription,garden,balcony,rented)) ;
      }

        recycler.setLayoutManager(new LinearLayoutManager(this));
        PropirtyAgencyAdabter adapter = new PropirtyAgencyAdabter(this,propirties);
