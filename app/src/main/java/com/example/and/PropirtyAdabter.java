...
public class PropirtyAdabter
        extends RecyclerView.Adapter<PropirtyAdabter.ViewHolder> {
    private Context context;
    private List<Propirty> items;


    public PropirtyAdabter(Context context, List<Propirty> items) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        CardView v = (CardView) LayoutInflater.from(parent.getContext()).inflate(R.layout.propcard, parent, false);
      ...
      //  Bitmap bitmap = BitmapFactory.decodeByteArray(image,0,image.length) ;
        ...
        cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context,PropirtyDetails.class) ;
